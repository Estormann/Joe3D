/*
  ...
  <Application.Resources>
      <vm:ViewModelLocator xmlns:vm="clr-namespace:Joe3D.WPF"
                           x:Key="Locator" />
  </Application.Resources>
...
namespace Joe3D.WPF.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        public Joe3D.ViewControl.ViewerViewModel Main
        {
            get
            {
                return ServiceLocator.Current.GetInstance<Joe3D.ViewControl.ViewerViewModel>();
            }
        }
